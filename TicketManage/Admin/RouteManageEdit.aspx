<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="RouteManageEdit.aspx.cs" Inherits="TicketManage.Admin.RouteManageEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    这里是航线编辑页面：
     <div>
        ...
        <asp:Button ID="btnEditRoute" runat="server" Text="修改" OnClick="btnEditRoute_Click"  />
    </div>
     <asp:Panel ID="Panel1" runat="server" Visible="false">
        <asp:Button ID="btnToRouteManage" runat="server" Text="修改成功，返回航线页面" OnClick="btnToRouteManage_Click" />
    </asp:Panel>
